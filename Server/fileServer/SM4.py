...
if __name__ == '__main__': 
    ...
    # print '密钥: ', sm4.__str__()
    # C = sm4.sm4_encrypt(message_padding(extmessage, SM4_PAD_PBOC), SM4_ECB)
    # print '密文: ', C
    # M = sm4.sm4_decrypt(C, SM4_ECB)
    # print '明文: ', M
    # print '-'*120
    ...
    # print '待加密数据: ', message
    # print '密钥: ', sm4.__str__()
    # C = sm4.sm4_encrypt(message_padding(message, SM4_PAD_PBOC), SM4_CBC)
    # print '密文: ', C
...
#83B62EA32666681BB4279A0989FBB2E5
#83B62EA32666681BB4279A0989FBB2E5
#83B62EA32666681BB4279A0989FBB2E5ABFE6FFEC9AFC149D232F78C5578D33A
